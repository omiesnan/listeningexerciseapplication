...
namespace LEA_by_DELAN
{
    public partial class Q10 : Form
    {
        ...
        {
            this.Close();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\LEA by DELAN\LEA by DELAN\Resources\AUD10.wav");
            player.Stop();
        }
        ...
        {
            Question.Question_Hint.Text10 ViewText10 = new Question.Question_Hint.Text10();
            ViewText10.ShowDialog();
        }
    }
}
