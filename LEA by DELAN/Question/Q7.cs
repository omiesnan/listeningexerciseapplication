...
namespace LEA_by_DELAN
{
    public partial class Q7 : Form
    {
        ...
        {
            this.Close();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\LEA by DELAN\LEA by DELAN\Resources\AUD7.wav");
            player.Stop();
        }
        ...
        {
            Question.Question_Hint.Text7 ViewText7 = new Question.Question_Hint.Text7();
            ViewText7.ShowDialog();
        }
    }
}
