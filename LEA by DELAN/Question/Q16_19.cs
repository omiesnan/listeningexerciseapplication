...
{
    public partial class Q16_19 : Form
    {
        ...
        {
            this.Close();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\LEA by DELAN\LEA by DELAN\Resources\AUD16-19.wav");
            player.Stop();
        }
        ...
        {
            Question.Question_Hint.Text16_19 ViewText16_19 = new Question.Question_Hint.Text16_19();
            ViewText16_19.ShowDialog();
        }
    }
}
