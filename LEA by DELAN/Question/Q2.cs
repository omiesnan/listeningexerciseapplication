...
namespace LEA_by_DELAN
{
    public partial class Q2 : Form
    {
        ...
        {
            this.Close();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\LEA by DELAN\LEA by DELAN\Resources\AUD2.wav");
            player.Stop();
        }
        ...
        {
            Question.Question_Hint.Text2 ViewText2 = new Question.Question_Hint.Text2();
            ViewText2.ShowDialog();
        }
    }
}
