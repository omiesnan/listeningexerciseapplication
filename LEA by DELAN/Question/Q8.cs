...
namespace LEA_by_DELAN
{
    public partial class Q8 : Form
    {
        ...
        {
            this.Close();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\LEA by DELAN\LEA by DELAN\Resources\AUD8.wav");
            player.Stop();
        }
        ...
        {
            Question.Question_Hint.Text8 ViewText8 = new Question.Question_Hint.Text8();
            ViewText8.ShowDialog();
        }
    }
}
