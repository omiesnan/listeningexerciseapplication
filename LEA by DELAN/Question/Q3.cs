...
namespace LEA_by_DELAN
{
    public partial class Q3 : Form
    {
        ...
        {
            this.Close();
            System.Media.SoundPlayer player = new System.Media.SoundPlayer(@"C:\LEA by DELAN\LEA by DELAN\Resources\AUD3.wav");
            player.Stop();
        }
        ...
        {
            Question.Question_Hint.Text3 ViewText3 = new Question.Question_Hint.Text3();
            ViewText3.ShowDialog();
        }
    }
}
